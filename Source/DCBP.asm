...
InitBreakPointsTables:
    pushad
        VirtualAlloc BreakPointsTables (MAX_BREAKPOINT*Size_of_BpOnTable);01000
        ;add eax 0800 | mov D$BpOffTable eax
        add eax ((MAX_BREAKPOINT*Size_of_BpOnTable)/2) | mov D$BpOffTable eax
    popad
ret
...
Proc GetcodeBreakPointPosFromSourcePointer:
    Arguments @BaseOfCode, @SourcePtr
...
;;
        ...
        ;If D$DebugBaseOfCode = 0
        ;    push eax
         ;   call 'Kernel32.OutputDebugStringA' {'Debug Base of Code not found !' 0}
         ;   pop eax
        ;End_If

        add eax D@BaseOfCode
