...
[..Do | F0:]
[..Loop_Until | #=3 | cmp #1 #3 | jn#2 F0<<]

[...Do | G0:]
[...Loop_Until | #=3 | cmp #1 #3 | jn#2 G0<<]
...
; The structure macro comes always after the local macro
...
;[EndSTD | P9: | &3 | mov esp ebp | pop ebp | ret]

[EndP | P9: | &3 | mov esp ebp | pop ebp | ret &1 | Align 16]
[EndSTD | P9: | &3 | mov esp ebp | pop ebp | ret | Align 16]
...
[Arg1 ebp+8    Arg2 ebp+12    Arg3 ebp+16    Arg4 ebp+20   Arg5 ebp+24
 Arg6 ebp+28   Arg7 ebp+32    Arg8 ebp+36    Arg9 ebp+40   Arg10 ebp+44
 Arg11 ebp+48  Arg12 ebp+52   Arg13 ebp+56   Arg14 ebp+60  Arg15 ebp+64
 Arg16 ebp+68  Arg17 ebp+72   Arg18 ebp+76   Arg19 ebp+80  Arg20 ebp+84]
...
[Local1 ebp-4     Local2 ebp-8     Local3 ebp-12    Local4 ebp-16    Local5 ebp-20
 Local6 ebp-24    Local7 ebp-28    Local8 ebp-32    Local9 ebp-36    Local10 ebp-40
 Local11 ebp-44    Local12 ebp-48    Local13 ebp-52    Local14 ebp-56    Local15 ebp-60
 Local16 ebp-64    Local17 ebp-68    Local18 ebp-72    Local19 ebp-76    Local20 ebp-80
 Local21 ebp-84    Local22 ebp-88    Local23 ebp-92    Local24 ebp-96    Local25 ebp-100]
...
[SizeOf1 4     SizeOf2 8     SizeOf3 12    SizeOf4 16    SizeOf5 20
 SizeOf6 24    SizeOf7 28    SizeOf8 32    SizeOf9 36    SizeOf10 40
 SizeOf11 44    SizeOf12 48    SizeOf13 52    SizeOf14 56    SizeOf15 60
 SizeOf16 64    SizeOf17 68    SizeOf18 72    SizeOf19 76    SizeOf20 80
 SizeOf21 84    SizeOf22 88    SizeOf23 92    SizeOf24 96    SizeOf25 100]
____________________________________________________________________________________________
____________________________________________________________________________________________
...
;;
    ...
    push eax
        ...
        push ecx
            add ecx TABLES_SECURITY
            call MemoryAlloc NewMem ecx
            ; Copy:
            mov edi eax
        ...
        add ecx D$NewMem | mov eax D@End, D$eax ecx
        ; Adjust and Save the new follow-up Pointer:
        mov ebx D@Mem, ebx D$ebx
        mov eax D@Pointer, eax D$eax
        sub eax ebx | add eax D$NewMem
        mov ebx D@Pointer, D$ebx eax
    pop eax

    ; properly free old memory
    mov ebx D@Mem
    call MemoryFree D$ebx | mov D$ebx 0

    ; and Save the new Mem to the correct pointer. (We are simply exchanging them after freeing):
    mov eax D$NewMem | mov ebx D@Mem, D$ebx eax
...
; Macros for save and restore stackpointers in RosAsm internall functions

[OldStackPointer: D$ 0]
[OldStackEBP: D$ 0]

[Ros_SaveStack | mov D$OldStackPointer esp]
[Ros_RestoreStack | mov esp D$OldStackPointer]
[Ros_ClearStack | and D$OldStackPointer 0]
...
; test on encode decode bos this: mov eax 121212121212
