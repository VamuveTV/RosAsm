...
Win32_Hlp:
    call Help D$hwnd, Win32HlpName, NoParameter, WinHlpMessage
ret
...
Mmedia_Hlp:
    call Help D$hwnd, MmediaHlpName, NoParameter, MmediaHlpMessage
ret
...
OpenGl_Hlp:
    call Help D$hwnd, OpenGlHlpName, NoParameter, OpenGlHlpMessage
ret
...
WinSock_Hlp:
    call Help D$hwnd, WinSockHlpName, NoParameter, WinSockHlpMessage
ret
...
SDL_Hlp:
    call Help D$hwnd, SDLRefName, NoParameter, SDLRefHlpMessage
ret
...
sqlite_Hlp:
    call Help D$hwnd, sqliteName, NoParameter, sqliteHlpMessage
ret
...
DevIL_Hlp:
    call Help D$hwnd, DevILName, NoParameter, DxHlpMessage
ret
...
Dx_Hlp:
    call Help D$hwnd, DxHlpName, NoParameter, DxHlpMessage
ret
...
RosAsmHelp:
    call Help D$hwnd, B_U_AsmName, B_U_AsmTop, RosAsmHlpMessage
ret
...
F2Help:
    If D$F2Name <> 0
        call Help D$hwnd, F2Name, NoParameter, F2HlpMessage
    End_If
ret
...
LicenseView:
    call Help D$hwnd, B_U_AsmName, RosAsmLicenceHelp, ContextHlpMessage
...
GPLView:
    call Help D$hwnd, B_U_AsmName, GplHelp, ContextHlpMessage
ret
...
Proc Help:
    Arguments @Address, @HelpFile, @Page, @ErrorMessage
    Uses ecx, edx

    call 'Shell32.ShellExecuteA' D@Address, open, D@HelpFile, D@Page, &NULL, &SW_SHOWNORMAL
    If eax <= 32
        push eax
            call 'User32.MessageBoxA' D@Address, D@ErrorMessage, FileNotFound, &MB_ICONINFORMATION+&MB_SYSTEMMODAL
        pop eax
    End_If
...
L8:         call 'USER32.SendDlgItemMessageA' D@Adressee, 10, &LB_GETCURSEL, 0, 0
        ...
        .Else_If D@wParam = &IDHELP
            call Help D$hwnd, B_U_AsmName, GUIDsHelp, ContextHlpMessage
