...
Proc CoolControlDlg_CreateTab:
    ...
    Else
        mov D@UseImage &TRUE
        push ecx | call 'User32.SendMessageA' D$edi, &TCM_SETIMAGELIST, 0, D$eax | pop ecx
    End_If
...
Proc LibScanDialog_EnableContinueMenu:
    ...
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Close, D@Enable
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Save_Report, D@Enable
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Single_Object_File, D@Enable
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_All_Object_Files, D@Enable
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Runtime_Objects_Only, D@Enable
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Exported_Objects_Only, D@Enable
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Build_Dis_File, D@Enable
...
Proc LibScanDialog_EnableContinueNextTabMenu:
    ...
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Next_Tab, D@Enable

    call 'USER32.EnableMenuItem' D$LibScanMenuHandle, M03_Last_Tab, ebx
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Last_Tab, D@Enable
  ; Invert
    If D@Enable = 1
        mov ebx &MF_GRAYED
        mov D@Enable 0
...
Proc LibScanDialog_EnableContinuePrevTabMenu:
    ...
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_Previous_Tab, D@Enable

    call 'USER32.EnableMenuItem' D$LibScanMenuHandle, M03_First_Tab, ebx
    call 'User32.SendMessageA' D$LibScanToolbarHandle, &TB_ENABLEBUTTON, M03_First_Tab, D@Enable
...
Proc LibScanDialog_ToggleToolbarText:
  ...
  ; get check state of menu item, invert, toggle band and set inverted check state
    ...
    call 'User32.SendMessageA' D$LibScanMenuHandle, &TB_AUTOSIZE, 0, 0
...
Proc strcpyEx:
    Arguments @OutBound, @InBound, @StrLen
    Uses ecx, esi, edi
