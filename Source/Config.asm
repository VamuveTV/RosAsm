...
[CalcName: 'Calc.exe', 0
 CalcNameTail: 0 #&MAX_PATH]                        ; If same dir

[EquatesName: 'Equates.equ', 0
 EquatesNameTail: 0 #&MAX_PATH]
...
[Win32HlpName: 'Win32.hlp', 0
 Win32HlpNameTail: 0 #&MAX_PATH] ;&MAX_PATH 0104  / 4 > 65d

[MmediaHlpName: 'Mmedia.hlp', 0
 MmediaHlpNameTail: 0 #60]

[OpenGlHlpName: 'OpenGl.hlp', 0
 OpenGlHlpNameTail: 0 #60]

;[OpcodeHlpName: 'x86eas.hlp', 0]        [OpcodeHlpNameTail: 0 #60]
;[WinDataFileName: 'WindowsData.inc', 0]     [WinDataFileNameTail: 0 #60]

[DxHlpName:    'directx.chm', 0
 DxHlpNameTail: 0 #60]

[WinsockHlpName: 'Winsock.hlp', 0
 WinsockHlpNameTail: 0 #60]

[SDLRefName: 'SDLRef.chm', 0
 SDLRefNameTail: 0 #60]

[sqliteName: 'sqlite.hlp', 0
 sqliteNameTail: 0 #60]

[DevILName: 'DevIL.html', 0
 DevILNameTail: 0 #60]

[ClipName: 'Clip.txt', 0
 ClipNameTail: 0 #60]

[B_U_AsmName: 'B_U_Asm.exe', 0
 B_U_AsmNameTail: 0 #60]
...
L1:         call 'User32.DestroyWindow' D@Adressee
        ...
        ..Else_If D@wParam = &IDHELP
            call Help D$hwnd, B_U_AsmName, ConfigHelp, ContextHlpMessage
...
L2:         .Else_If D$ConfigTabIndex = 3           ; Colors.
            ...
            .Else_If D$ConfigTabIndex = 4           ; Help Files.
                If eax = 500
                    call Help D$hwnd, B_U_AsmName, HelPFiles, ContextHlpMessage
                Else
...
L2:             popad
          ...
          ; Tag Dialog 4800
             ...
             .Else_If D$ConfigTabIndex = 10          ; API verifications
                ...
                sub eax CFG_DLL_CHECK_NORMAL | mov D$ApiCheckFlag eax
...
[CFG_DLL_CHECK_NORMAL 10] ; Normal behaviour. Same as LoadLibrary => ApiCheckFlag = 0
[CFG_DLL_CHECK_DONT_RESOLVE_DLL_REF 11] ; &DONT_RESOLVE_DLL_REFERENCES => ApiCheckFlag = 1
[CFG_DLL_CHECK_DONT_VERIFY 12] ; &LOAD_LIBRARY_AS_DATAFILE => ApiCheckFlag = 2

InitTabAPI:
    ;mov eax 10 | add eax D$ApiCheckFlag
    mov eax CFG_DLL_CHECK_NORMAL | add eax D$ApiCheckFlag

    call 'User32.SendDlgItemMessageA' D$ConfigTabbedDialogHandle, eax, &BM_SETCHECK, &BST_CHECKED, 0
