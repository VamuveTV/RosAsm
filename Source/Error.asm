...
SetDebuggeeText:
    ...
    Do
        lodsb | On al = LF, inc ebx
    Loop_Until esi >= D$BlockStartTextPtr
...
L0: Ros_RestoreStack               ; restore stack (...comming from anywhere)
...
;;
    Guga fix 10/04/2020
    Used functions are: VerifyFunctionExist

    Note: The LenOfSearchedString and SearchString must be previously calculated as in VerifyFunctionExist
...
;    call ErrorMessageBox esi, D$ErrorMessagePtr
    ...
    ;call StrLenProc D$StartOfFunctionName
    ;C_call FormatStr edi, {'%s' 0}, D$StartOfFunctionName
...
;    mov D$LenOfSearchedString ecx
    ...
    call ErrorMessageBox SearchString, D$ErrorMessagePtr
