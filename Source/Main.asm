...
[ClassName: B$ 'RosAsmWindowClass' 0   EditClassName: 'EDIT' 0
 AppName: '  RosAsm, The Bottom-Up Assembler -V.2.055b-' 0]
...
;[IncludesOK: ?
[RichEditHandle: ? RichEditXPHandle: ?]

Main:
  ; For the Resurces Editor:
    call 'KERNEL32.LoadLibraryA' {'riched20.dll',0} | mov D$RichEditHandle eax
    call 'KERNEL32.LoadLibraryA' {"Msftedit.dll", 0} | mov D$RichEditXPHandle eax;show RichEdit50Wclass for resources edition ShowDialogResult
...
Proc BlinkProc:
    Arguments @hWnd, @uMsg, @idTimer, @dwTime
