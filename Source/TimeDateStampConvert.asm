...
Proc CurrentTimeStampToString:
    ...
    Structure @St_UTC 16, @St_UTC.wYearDis 0, @St_UTC.wMonthDis 2, @St_UTC.wDayOfWeekDis 4, @St_UTC.wDayDis 6, @St_UTC.wHourDis 8, @St_UTC.wMinuteDis 10,
                          @St_UTC.wSecondDis 12, @St_UTC.wMillisecondsDis 14
    ...
    call 'KERNEL32.SystemTimeToFileTime' D@St_UTC, St_DateTimeStamp

    If D@FileTimeStr <> 0
        mov edi D@FileTimeStr
        mov esi St_DateTimeStamp
        mov ecx 0
        While ecx <> Size_Of_FILETIME
            movsb
            inc ecx
    ...
    call 'kernel32.FileTimeToSystemTime' St_DateTimeStamp D@St_UTC
    call 'KERNEL32.GetTimeFormatA' &LOCALE_SYSTEM_DEFAULT &NULL D@St_UTC D@TimeFmt D@TimeOut &MAX_UTC_TIME_LEN
...
; This old one is not working. St_DateTimeStamp Must be global and not local variable
Proc CurrentTimeStampToString2:
    Arguments @TimeFmt, @TimeOut, @SysTimeStr, @FileTimeStr
    Local @St_DateTimeStamp.dwLowDateTime, @St_DateTimeStamp.dwHighDateTime
    Structure @St_UTC 16, @St_UTC.wYearDis 0,  @St_UTC.wMonthDis 2,  @St_UTC.wDayOfWeekDis 4,  @St_UTC.wDayDis 6,  @St_UTC.wHourDis 8,  @St_UTC.wMinuteDis 10,  @St_UTC.wSecondDis 12,  @St_UTC.wMillisecondsDis 14
