           ...
           ifnot op3 'D', L3>
             ifnot op4 'Q', L4>
               ifnot op5 'U', L5>       ; LDDQU
                IfNot B$Operands MemToReg, L6>
                ToOpcode 0F2 | mov Op1 0F0 | jmp XMMTOFromMem; Now it can assemble "lddqu XMM1 X$esi", "lddqu X$esi XMM1", etc Older one was a jmp to MMXmemXMM
L6: BadOperand
L2:      ifnot op2 'E', L2>
           ifnot op3 'A', L3>
             ifnot op4 'V', L4>
           ...
           ifnot op3 'T', L3>
             ifnot op4 'S', L4>
               ifnot op5 'C', L5>
                 ...
                 ;mov op1 00_1111,  op2 00__1111_1001 | jmp op_op
                 ToOpcode 0F, 01, 0F9 | ret
L6:              ;BadMnemonic
L5:            ;BadMnemonic
L4:          ;BadMnemonic
L3:        ;BadMnemonic
             ...
             ifnot op4 'F', L4>
               ifnot op5 'P', L5>
                 ...
                 ;   01100110:00001111:11000110:11 xmmreg1 xmmreg2:imm8 (0/255)
                    ToOpcode 001100110 | mov op1 0011000110 | jmp XmmMemXmmImm8 ;  jmp XmmMemXmmImm8 ; jmp XMMmemXMMimm3 (Updated to SSE2 in 03/05/2020 using imm8 rather then imm3
             ...
             ifnot op3 'H', L3>
               ifnot op4 'U', L4>
                 ifnot op5 'F', L5>
                   ...
                   ifnot op6 'L', L6>
                       ToOpcode 0011110010
P0:                    mov op1 001110000 | jmp XmmMemXmmImm8 ; jmp XmmMemXmmImm3 (Updated to SSE2 in 03/05/2020 using imm8 rather then imm3
L3:          ifnot op3 'U', L3>
               ifnot op4 'B', L4>
                 ifnot op5 'U', L5>
                   ifnot op6 'S', L6>
