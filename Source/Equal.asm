...
Proc ComputeImmediateExpression:
    ...
    Local @ValueExponent @temp, @FpuErrorMode
    Uses ecx, esi, edi
    ...
    call FloatToUString EPP_ImmediateResult, EPP_ImmediateResultString, DISASM_ROUND_MODE, &FALSE
    mov D@FpuErrorMode eax

    .If D@FpuErrorMode >= SpecialFPU_QNAN
        error EqualPreparser_InvalidImmVal
;;
    .If D@FpuErrorMode = SpecialFPU_QNAN
        jmp L1>>
...
; same as Loop_Until ecx = 0, but faster
[Test_Until_Zero | test #1 #1 | jne D0<]
