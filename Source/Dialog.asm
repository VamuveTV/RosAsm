...
[DLGTEMPLATE.dlgVerDis 0
 DLGTEMPLATE.signatureDis 2
 DLGTEMPLATE.helpIDDis 4
 DLGTEMPLATE.exStyleDis 8
 DLGTEMPLATE.StyleDis 12
 DLGTEMPLATE.cditDis 16
 DLGTEMPLATE.xDis 18
 DLGTEMPLATE.yDis 20
 DLGTEMPLATE.lxDis 22
 DLGTEMPLATE.lyDis 24]

[Size_Of_DLGTEMPLATE 28]

[DLGITEMTEMPLATE.styleDis 0
 DLGITEMTEMPLATE.dwExtendedStyleDis 4
 DLGITEMTEMPLATE.xDis 8
 DLGITEMTEMPLATE.yDis 10
 DLGITEMTEMPLATE.lxDis 12
 DLGITEMTEMPLATE.cyDis 14
 DLGITEMTEMPLATE.idDis 16]

[Size_Of_DLGITEMTEMPLATE 20]
...
;    call 'KERNEL32.LoadLibraryA' {"Msftedit.dll", 0} ; show RichEdit50Wclass
...
L1:         call Help D$hwnd, B_U_AsmName, DialogHelp, ContextHlpMessage | jmp L7>>
...
ShowControlStyleControl:
    push D$DialogListIndex
       ...
       ..Else                                                   ; (edi = ControlClassByNames)
            ...
            .Else_If ebx = 20 | ShowSetOfCheckBoxes RichEdit20aTextTable
            .End_If
       ..End_If
...
SearchWhatControlClass:
    ...
    ..Else
        ...
        .Else_If D$edi+1 = 'SysL'  ; SysLink
            mov ebx 19
        .Else_If D$edi+8 = 't50W'  ; RichEdit50W
            mov ebx 20
        .End_If
...
Proc NewOrExistingMenuProc:
    ...
    ...Else_If D@Message = &WM_COMMAND
        ...
        Else_If D@wParam = &IDHELP
            call Help D$hwnd, B_U_AsmName, DialogHelp, ContextHlpMessage
    ...
    ...Else                                  ; >>> this is for Control Style:
        ...
        ..Else                                         ; >>> class by Name
            ...
            .Else_If ebx = 19
                ...
                mov esi SysLinkBitTable
            .Else_If ebx = 20
                move D$CheckMust D$RichEdit20aMustHaveBitTable+eax    ; RichEdit20W
                move D$CheckExclude D$RichEdit20aExcludeBitTable+eax
                move D$CheckingMask RichEdit20aCheckingMask
                move D$CheckBit D$RichEdit20aBitTable+eax
                mov esi RichEdit20aBitTable
