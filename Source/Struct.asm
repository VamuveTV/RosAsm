...
[Max_SubMenu_Itens 100] ;  Maximum amount of subtitens on each new submenu (visualtuts, clips and wizards)

[M01_Structures 4000]
[M01_Structures_Max (M01_Structures+Max_SubMenu_Itens)]
...
L1:         mov D$StructHandle 0
        ...
        .Else_If D@wParam = &IDHELP
            call Help D$hwnd, B_U_AsmName, StructHelp, ContextHlpMessage
...
[UserStructTitle: ? #50]
;[StructEditText: ? #1000]
[StructEditText: ? #MAX_STRUCT_EDIT_TEXTBUFF]
[MAX_STRUCT_EDIT_TEXTBUFF 190000]
...
OpenStructureFile:
    .If B$StructuresFileOK = &FALSE
        call Help D$hwnd, B_U_AsmName, IncludeFilesHelp, ContextHlpMessage | ret
...
; MAX_STRUCT_EDIT_TEXTBUFF temporary solution. It must have ni limits due to really huge wdm structures
BuildStructForm:
    mov edi StructEditText, eax 0, ecx MAX_STRUCT_EDIT_TEXTBUFF | rep stosd
...
;                        ^
    ..If B$esi+1 = '|'
        ...
        Else_If_Or B$esi = 'W', B$esi = 'U'
            add D$StructDisplacement 2
        Else_If_Or B$esi = 'D', B$esi = 'F'
            add D$StructDisplacement 4                                   ; WinStructures
        Else_If_Or B$esi = 'Q', B$esi = 'R'
            add D$StructDisplacement 8
        Else_If B$esi = 'T'
            add D$StructDisplacement 10
        End_If
        inc esi
;;
        If B$esi = 'B'
...
L4:
            ...
            pushad
                ...
                .While B$esi > ' '
                    ...
                    .If_Or B$esi = '+', B$esi-1 = '+'
                        ; [MODULEENTRY32:|szModule B MAX_MODULE_NAME32+1|szExePath B MAX_PATH
                        ...
                        call FindNumberInsideStructure
                        If eax <> &FALSE
                            On B$esi-1 = '+', dec edi
                            mov al 0 | stosb; &WSADESCRIPTION_LEN &WSASYS_STATUS_LEN
                            move D$NumtoAddtoImm32 D$ClickedNumberValue.Conv32Bit
                            jmp L4>
                        End_If
                    ;.Else_If B$esi = ' '
                     ;   inc esi
...
L6:     If bl = 'B'
            mov eax 1
        Else_If_Or bl = 'W', bl = 'U'
            mov eax 2
        Else_If_Or bl = 'D', bl = 'F'
            mov eax 4
        Else_If_Or bl = 'Q', bl = 'R'
            mov eax 8
        Else_If bl = 'T'
            mov eax 10
        Else
...
Proc FindNumberInsideStructure:
    Uses esi, ecx, edx, edi, ebx
...
L0:         lodsb | call WordEdge | cmp B$Edge &TRUE | jne L0<
    ...
    If eax <> &FALSE
        mov eax D$ClickedNumberValue.Conv32Bit
    End_If
