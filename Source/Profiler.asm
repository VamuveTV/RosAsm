...
L0:     call 'KERNEL32.WaitForDebugEvent' DEBUG_EVENT, &INFINITE
        ...
        .If D$DEBUG_EVENT+DEBUG_EVENT.dwDebugEventCodeDis = &EXIT_PROCESS_DEBUG_EVENT;DE.dwDebugEventCode = &EXIT_PROCESS_DEBUG_EVENT
            jmp L9>>

        .Else_If D$DEBUG_EVENT+DEBUG_EVENT.dwDebugEventCodeDis = &EXCEPTION_DEBUG_EVENT;DE.dwDebugEventCode = &EXCEPTION_DEBUG_EVENT
...
;hexprint D$E.ExceptionAddress
        ...
        call 'KERNEL32.ContinueDebugEvent' D$DEBUG_EVENT+DEBUG_EVENT.dwProcessIdDis, D$DEBUG_EVENT+DEBUG_EVENT.dwThreadIdDis, &DBG_EXCEPTION_NOT_HANDLED
        ;call 'KERNEL32.ContinueDebugEvent' D$DE.dwProcessId, D$DE.dwThreadId, &DBG_EXCEPTION_NOT_HANDLED
    .End_While
