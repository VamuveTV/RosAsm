...
L5:
    ...
    call FillResourceTypeList CustomList, ManifestList, ManifestListPtr, &RT_MANIFEST, MAXMANIFEST
...
NewTemporaryFillRsrcList:
  ...
  ; Store default icon if user didn't edit any (or user defined if any):
    ...
    mov esi ManifestList
    If D$esi > 0
        While D$esi > 0
            mov eax &RT_MANIFEST | stosd | movsd | mov eax Language | stosd
            movsd | movsd
        End_While
    End_If
