...
L6:                         add edx 4
                      ...
                      ; Zero end Case sensitive recopy of the MnemonicCopy for ShellExecute:
                        ...
                        End_While
                        mov B$edi 0
                        call Help D$hwnd, B_U_AsmName, MnemonicCopy, FileNotFound
                        If eax <= 32
                            jmp L9>
                        Else
...
L5:         VirtualFree D$DataTextTable, D$StructureTextTable
        ...
        Else_If eax = &IDHELP
            call Help D$hwnd, B_U_AsmName, StructuresHelp, ContextHlpMessage
        Else_If eax = 5     ; [ >>>>>>>> ]
    ...
    ...Else_If D@Message e &WM_INITDIALOG
        ...
        call 'USER32.SendMessageA' eax, &EM_SetLimitText, 0, 0 ; max limit to display is 2 gb

        call 'user32.GetDlgItem' D@Adressee, 11
        call 'USER32.SendMessageA' eax, &EM_SetLimitText, 0, 0 ; max limit to display is 2 gb

        ;VirtualAlloc DataTextTable 01000, StructureTextTable 01000
        VirtualAlloc DataTextTable MAX_STRUCT_EDIT_TEXTBUFF, StructureTextTable MAX_STRUCT_EDIT_TEXTBUFF
