...
Proc CoolControlWin_CreateCommandTB:
    ...
    .If D$ecx <> 0
        Do
            push ecx | call 'User32.SendMessageA' D$ecx, &TB_GETSTATE, D$ebx+TBBUTTON.idCommandDis, 0 | pop ecx
    ...
    mov D$ecx eax
    push ecx | call 'User32.SendMessageA' D$ecx, &TB_BUTTONSTRUCTSIZE, SizeOf_TBBUTTON, 0 | pop ecx

    mov eax D$esi+TBWIN_CMD.hImlDis
    push ecx | call 'User32.SendMessageA' D$ecx, &TB_SETIMAGELIST, 0, D$eax | pop ecx
  ...
  ; Activate / Deactivate Text
    ...
    mov ebx D@ToolStructure
    push ecx | call 'User32.SendMessageA' D$ecx, &TB_ADDBUTTONS, D@TotalButtons, ebx | pop ecx
...
Proc CoolControlDialog_AdjustDataTabSize:
    ...
    call 'User32.SendMessageA' D@TabHandle, &TCM_ADJUSTRECT, &FALSE, esi
