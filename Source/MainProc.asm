...
[M00_Menu  1000                  M00_Open  1001                  M00_New  1002
 ...
 M00_Load_Manifest  1063         M00_Delete_Manifest  1064       M00_Manifest_ID  1065
 M00_Save_Manifest  1066         M00_New_Dialog  1067            M00_Load_from_Resources  1068
 M00_Load_from_ClipBoard  1069   M00_Load_from_File  1070        M00_Save_to_Binary_File  1071
 M00_Load_from_Binary_File  1072 M00_Replace_from_Binary_File  1073
 M00_Delete_Resources_Dialog  1074                               M00_Strings  1075
 M00_New_Menu  1076              M00_Existing_Menu  1077         M00_Delete_a_Menu  1078
 M00_Save_to_Binary_Menu_File  1079                              M00_Load_Binary_Menu_File  1080
 M00_Replace_from_Binary_Menu_File  1081                         M00_Clip_File  1082
 M00_Structures  1083            M00_Api_Functions  1084         M00_Sys_Resources  1085
 M00_GUIDs  1086                 M00_Win32_Equates  1087         M00_Win32_Data_Types  1088
 M00_Wizards  1089               M00_B_U_Asm  1090               M00_Sources_Editor  1091
 M00_Visual_Tuts  1092           M00_Win32_hlp  1093             M00_Mmedia_hlp  1094
 M00_OpenGl_hlp  1095            M00_WinSock_hlp  1096           M00_Dx_hlp  1097
 M00_SDL  1098                   M00_sqlite  1099                M00_DevIl  1100
 M00_About  1101                 M00_GPL_License  1102           M00_RosAsm_License  1103
 M00_<<<<  1104                  M00_>>>>  1105]
...
; Main window CallBack: User choices open-file independant:
    ...
    ...Else_If eax = &WM_COMMAND
        ...
        ..Else_If eax = M00_Sources_Editor
            call Help D$hwnd, B_U_AsmName, SourceEditor, ContextHlpMessage
        ...
        ..Else_If eax = M00_Load_MAnifest
            CloseDebuggerOrIgnore
            call ReadManifest | call EnableMenutems | jmp NotReadyToRun

        ..Else_If eax = M00_Manifest_ID
            ;call ReadManifest | call EnableMenutems | jmp NotReadyToRun

        ..Else_If eax = M00_Save_Manifest
            CloseDebuggerOrIgnore
            call SaveManifest | jmp NotReadyToRun

        ..Else_If eax = M00_Delete_Manifest
            CloseDebuggerOrIgnore
            call DeleteManifest | call EnableMenutems | jmp NotReadyToRun
        ...
        ..Else
            ...
            .Else_If eax => M01_Structures;3999             ; Added FloatMenu under [Struct].
                If eax <= M01_Structures_Max;4010
...
L9: popad | mov eax &FALSE | ExitP;jmp P9>>
...
L7: ; NotReadyToRun:
    ...
    popad | mov eax &FALSE | ExitP;jmp P9>
...
Compile:
        ...
        call AsmMain | Ros_ClearStack;mov D$OldStackPointer 0
...
Security:
    ...
    ...If B$SecurityWanted = &TRUE
        ..If B$SourceHasChanged = &TRUE
            call 'user32.MessageBoxA' D$hwnd, QuitMessage, QuitTitle, &MB_YESNOCANCEL
            .If eax = &IDYES
                call RestoreRealSource
                call AsmMain | Ros_ClearStack;mov D$OldStackPointer 0
                If B$CompileErrorHappend = &FALSE
...
EnableMenutems:
   ; call 'USER32.EnableMenuItem' D$MenuHandle, M00_Profile, &MF_GRAYED
    ...
    If D$ManifestList = 0
        call 'USER32.EnableMenuItem' D$MenuHandle, M00_Delete_Manifest, &MF_GRAYED
        call 'USER32.EnableMenuItem' D$MenuHandle, M00_Manifest_ID, &MF_GRAYED
        call 'USER32.EnableMenuItem' D$MenuHandle, M00_Save_Manifest, &MF_GRAYED
    Else
        call 'USER32.EnableMenuItem' D$MenuHandle, M00_Delete_Manifest, &MF_ENABLED
        call 'USER32.EnableMenuItem' D$MenuHandle, M00_Manifest_ID, &MF_ENABLED
        call 'USER32.EnableMenuItem' D$MenuHandle, M00_Save_Manifest, &MF_ENABLED
    End_If
