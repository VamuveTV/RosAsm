...
; List of error messages:
 ...
 [EmptyString: B$   '                                                        ', 0
  ...
  OrphanPrefix:     'An instruction prefix can not stand alone. Use separator sign ( | ) in betwen spaces.', 0
...
#1 #2 out of range", 0
  ...
  Please, consider fixing the sytax manually the next time you assemble your program, to avoid this warning.", 0
]
...
; Debugger strings
 ...
 3090 StrSaveDumpedPtr: StrDumpMemory
 ...
 3122 FmtBinaryMMXPtr: FmtBinaryMMX
 3123 FmtBinarySSEPtr: FmtBinarySSE
 3124 FmtBinaryFPUPtr: FmtBinaryFPU
